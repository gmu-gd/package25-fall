...
---
### Description
Design and construct a package that contains three variations of the same (or similar) item. You will create a visual identity, design for the packaging the items, and the labels/packaging for the items themselves. The design of the items must work as a system, not as three individual designs.
